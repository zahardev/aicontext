...
2. **Development Flow** — remaining Development Flow skills (`/plan-tasks`, `/run-task`, `/check-task`, `/finish-task`, `/do-it`, `/align-context`, `/next-step`, `/review-plan`, `/commit`, `/challenge`)
