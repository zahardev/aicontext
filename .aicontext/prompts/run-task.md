...
5. If verification added or resumed a step, return to Section 2 to execute it, then repeat this section. Otherwise: `All steps complete. Run {native finish-task invocation} to close the task.`
