...
- If unchecked plan steps remain → `Run {native next-step invocation} to continue.`
- If this was the last unchecked step → `Final step closed. Run {native finish-task invocation} to close the task.`
