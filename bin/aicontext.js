...
const FRAMEWORK_PROMPTS = [
  ...
  'draft-pr.md', 'make-pr.md', 'finish-task.md', 'close-task.md', 'pr-review-loop.md', 'generate.md', 'gh-fix-tests.md', 'gh-review-fix-loop.md', 'next-step.md', 'plan-tasks.md',
